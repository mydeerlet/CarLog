package com.mydeerlet.carlog.view;
...
import com.mydeerlet.carlog.utils.ScreenSizeUtils;
...
public class PPImageView extends AppCompatImageView {
    ...
    public static void setImageUrl(PPImageView view, String imageUrl, boolean isCircle, int radius) {
        ...
        if (isCircle) {
            ...
            builder.transform(new RoundedCornersTransformation(ScreenSizeUtils.dp2px(radius), 0));
        }
    ...
    public void bindData(int widthPx, int heightPx, int marginLeft, String imageUrl) {
        bindData(widthPx, heightPx, marginLeft, ScreenSizeUtils.getScreenWidth(), ScreenSizeUtils.getScreenWidth(), imageUrl);
    }
    ...
    private void setSize(int width, int height, int marginLeft, int maxWidth, int maxHeight) {
        ...
        if (params instanceof FrameLayout.LayoutParams) {
            ((FrameLayout.LayoutParams) params).leftMargin = height > width ? ScreenSizeUtils.dp2px(marginLeft) : 0;
        } else if (params instanceof LinearLayout.LayoutParams) {
            ((LinearLayout.LayoutParams) params).leftMargin = height > width ? ScreenSizeUtils.dp2px(marginLeft) : 0;
        }
